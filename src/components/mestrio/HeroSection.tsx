  ...
  return (
    <section className="px-6 py-16 md:py-24 flex flex-col items-center justify-center text-center bg-gradient-to-b from-primary/5 to-background">
      ...
      <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 max-w-4xl">
        Find verified construction workers in your area
      </h1>
      
      <p className="text-muted-foreground mb-8 max-w-2xl text-lg md:text-xl">
        Connect with skilled electricians, plumbers, painters, and carpenters. 
        Get quotes, read reviews, and hire with confidence.
      </p>
      ...
      <form
        ...
        className="w-full max-w-3xl bg-card border border-border rounded-xl p-6 md:p-8 shadow-lg"
      >
