...
export function Logo({ variant = "horizontal", className = "", showTagline = false }: LogoProps) {
  ...
  if (variant === "vertical") {
    return (
      <Link href="/" className={`inline-flex flex-col items-center gap-2 ${className}`}>
        <img src="https://cdn.builder.io/api/v1/image/assets%2Fadadeadcfd004af090dcf2211799ead3%2F85b3ba6e772049b9ab57395fc189be09" alt="Mestrio" className="w-72 h-auto" />
  ...
  return (
    <Link href="/" className={`inline-flex items-center shrink-0 ${className}`}>
      <img src="https://cdn.builder.io/api/v1/image/assets%2Fadadeadcfd004af090dcf2211799ead3%2F85b3ba6e772049b9ab57395fc189be09" alt="Mestrio" className="h-16 w-auto" />
    </Link>
  );
}
